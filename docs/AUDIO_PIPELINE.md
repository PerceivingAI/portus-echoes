...
## 5. 30-Minute Recording Capacity & Customization

PortusEchoes ships configured out of the box for up to **30 minutes (1,800 seconds)** of uninterrupted recording across all modes and models:
- **Offline Local:** Buffer queues maintain a 30-minute capacity with continuous segment memory drainage, preventing memory growth during long sessions.
...
- **Cloud Live (OpenAI Realtime):** Streams audio continuously with a 30-minute session limit.
